...
require_once __DIR__ . "/../php/user_model.php";

$user = user_find_by_id((int) $_SESSION["user_id"]);
if (!$user) {
    ...
    <div class="auth-grid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php } ?>
                <?php if ($msg === "fail") { ?>
                    <div class="alert">Update failed. Please try again.</div>
                <?php } ?>
                ...
                <form method="POST" action="../php/profile_update_controller.php">
                    ...
                    <input type="text" name="location" required value="<?php echo htmlspecialchars($user["location"]); ?>">

                    <label>Area (optional)</label>
                    <input type="text" name="area" value="<?php echo htmlspecialchars($user["area"] ?? ""); ?>">
